...
import static by.yermak.elibrary.database.entity.user.Role.ADMIN;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(urlConfig -> urlConfig
                        .antMatchers("/login", "/users/registration","/users","/books","/registration", "/v3/api-docs/**", "/swagger-ui/**").permitAll()
